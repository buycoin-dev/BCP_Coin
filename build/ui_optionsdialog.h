...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        OptionsDialog->setStyleSheet(QStringLiteral("background-image: url(:/images/bkg);"));
        OptionsDialog->setModal(true);
        verticalLayout = new QVBoxLayout(OptionsDialog);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        tabWidget = new QTabWidget(OptionsDialog);
        tabWidget->setObjectName(QStringLiteral("tabWidget"));
        tabWidget->setStyleSheet(QStringLiteral("background-image: url(:/images/bkg);"));
        ...
        transactionFeeInfoLabel->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        transactionFeeLabel->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        reserveBalanceInfoLabel->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        reserveBalanceLabel->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        bitcoinAtStartup->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        mapPortUpnp->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        connectSocks->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        proxyIpLabel->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        proxyIp->setStyleSheet(QStringLiteral("background-color: rgb(106, 131, 154);"));
        ...
        proxyPortLabel->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        proxyPort->setStyleSheet(QStringLiteral("background-color: rgb(106, 131, 154);"));
        ...
        socksVersionLabel->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        minimizeToTray->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        minimizeOnClose->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        langLabel->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        unitLabel->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        coinControlFeatures->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        minimizeCoinAge->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        useBlackTheme->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        statusLabel->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        okButton->setStyleSheet(QStringLiteral("background-color: rgb(255, 153, 51);background-image: url(:/images/bgbfree);"));

        horizontalLayout_Buttons->addWidget(okButton);

        cancelButton = new QPushButton(OptionsDialog);
        cancelButton->setObjectName(QStringLiteral("cancelButton"));
        cancelButton->setStyleSheet(QStringLiteral("background-color: rgb(255, 153, 51);background-image: url(:/images/bgbfree);"));
        ...
        applyButton->setStyleSheet(QStringLiteral("background-color: rgb(255, 153, 51);background-image: url(:/images/bgbfree);"));
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start BuyCoin after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start BuyCoin on system login", 0));
        tabWidget->setTabText(tabWidget->indexOf(tabMain), QApplication::translate("OptionsDialog", "&Main", 0));
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the BuyCoin client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the BuyCoin network through a SOCKS proxy (e.g. when connecting through Tor).", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting BuyCoin.", 0));
#endif // QT_NO_TOOLTIP
