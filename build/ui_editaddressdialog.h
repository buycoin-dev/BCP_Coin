...
public:
    ...
    void setupUi(QDialog *EditAddressDialog)
    {
        ...
        EditAddressDialog->setStyleSheet(QStringLiteral("background-image: url(:/images/bkg);"));
        ...
        labelEdit->setStyleSheet(QStringLiteral("background-image: url(:/images/gr);"));
        ...
        addressEdit->setStyleSheet(QStringLiteral("background-image: url(:/images/gr);"));
