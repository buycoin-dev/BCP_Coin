...
public:
    ...
    void setupUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        SignVerifyMessageDialog->setStyleSheet(QStringLiteral("background-image: url(:/images/bkg);"));
        ...
        addressIn_SM->setStyleSheet(QLatin1String("background-image: url(:/images/bgbfree);\n"
"background-color: rgb(106, 131, 154);"));
        ...
        addressBookButton_SM->setStyleSheet(QLatin1String("background-color: rgb(106, 131, 154);\n"
"background-image: url(:/images/bgbfree);"));
        ...
        pasteButton_SM->setStyleSheet(QLatin1String("background-color: rgb(106, 131, 154);\n"
"background-image: url(:/images/bgbfree);"));
        QIcon icon1;
        ...
        signatureOut_SM->setStyleSheet(QStringLiteral("background-color: rgb(106, 131, 154);"));
        ...
        copySignatureButton_SM->setStyleSheet(QLatin1String("background-image: url(:/images/bgbfree);\n"
"background-color: rgb(106, 131, 154);"));
        QIcon icon2;
        ...
        signMessageButton_SM->setStyleSheet(QLatin1String("background-color: rgb(106, 131, 154);\n"
"background-image: url(:/images/bgbfree);"));
        QIcon icon3;
        ...
        clearButton_SM->setStyleSheet(QLatin1String("background-color: rgb(106, 131, 154);\n"
"background-image: url(:/images/bgbfree);"));
        QIcon icon4;
        ...
        statusLabel_SM->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        addressIn_VM->setStyleSheet(QStringLiteral("background-color: rgb(106, 131, 154);"));
        ...
        addressBookButton_VM->setStyleSheet(QLatin1String("background-color: rgb(106, 131, 154);\n"
"background-image: url(:/images/bgbfree);"));
        ...
        signatureIn_VM->setStyleSheet(QStringLiteral("background-color: rgb(106, 131, 154);"));
        ...
        verifyMessageButton_VM->setStyleSheet(QLatin1String("background-color: rgb(106, 131, 154);\n"
"background-image: url(:/images/bgbfree);"));
        QIcon icon5;
        ...
        clearButton_VM->setStyleSheet(QLatin1String("background-color: rgb(106, 131, 154);\n"
"background-image: url(:/images/bgbfree);"));
        ...
        statusLabel_VM->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
    ...
    void retranslateUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        addressIn_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The address to sign the message with (e.g. JgZaH1DdikpMTYc2x1Xb6eFBkKGibjmPb9)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        signMessageButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this BuyCoin address", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        addressIn_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The address the message was signed with (e.g. JgZaH1DdikpMTYc2x1Xb6eFBkKGibjmPb9)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        verifyMessageButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified BuyCoin address", 0));
#endif // QT_NO_TOOLTIP
