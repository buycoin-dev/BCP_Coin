...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        OverviewPage->setStyleSheet(QStringLiteral("color: rgb(4, 5, 70);"));
        ...
        labelAlerts->setStyleSheet(QLatin1String("background-color: qlineargradient(x1: 0, y1: 0, x2: 1, y2: 0, stop:0 #F0D0A0, stop:1 #F8D488);  color:#6a839a\n"
""));
        ...
        QPalette palette;
        QBrush brush(QColor(4, 5, 70, 255));
        brush.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::WindowText, brush);
        QBrush brush1(QColor(124, 255, 24, 255));
        ...
        labelBalance->setPalette(palette);
        QFont font1;
        font1.setBold(true);
        font1.setWeight(75);
        ...
        labelBalance->setText(QStringLiteral("0 BCP"));
        ...
        labelStake->setText(QStringLiteral("0 BCP"));
        ...
        labelUnconfirmed->setStyleSheet(QStringLiteral("gridline-color: rgb(170, 0, 127);"));
        labelUnconfirmed->setText(QStringLiteral("0 BCP"));
        ...
        labelImmature->setText(QStringLiteral("0 BCP"));
        ...
        labelTotal->setText(QStringLiteral("0 BCP"));
        ...
        listTransactions->setStyleSheet(QStringLiteral("background-color: rgba(106, 131, 154, 101);"));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the BuyCoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the BuyCoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
