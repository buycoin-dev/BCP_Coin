...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        AboutDialog->resize(617, 319);
        AboutDialog->setStyleSheet(QStringLiteral("background-image: url(:/images/bkg);"));
        ...
        versionLabel->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        copyrightLabel->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        buttonBox->setSizeIncrement(QSize(2, 2));
        buttonBox->setBaseSize(QSize(222, 0));
        QFont font;
        font.setBold(false);
        ...
        buttonBox->setStyleSheet(QLatin1String("background-color: rgb(255, 153, 51);\n"
"background-image: url(:/images/bgbfree);"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About BuyCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>BuyCoin</b> version", 0));
...
"Copyright \302\251 2014-2017 The BlackCoin developers\n"
"Copyright \302\251 2017 The BuyCoin developers", 0));
