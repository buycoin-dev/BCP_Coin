...
public:
    ...
    void setupUi(QDialog *AskPassphraseDialog)
    {
        ...
        AskPassphraseDialog->setStyleSheet(QStringLiteral("background-image: url(:/images/bkg);"));
        verticalLayout = new QVBoxLayout(AskPassphraseDialog);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        warningLabel = new QLabel(AskPassphraseDialog);
        warningLabel->setObjectName(QStringLiteral("warningLabel"));
        warningLabel->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        passLabel1->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        passEdit1->setStyleSheet(QStringLiteral("background-image: url(:/images/gr);"));
        ...
        passLabel2->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        passEdit2->setStyleSheet(QStringLiteral("background-image: url(:/images/gr);"));
        ...
        passLabel3->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        passEdit3->setStyleSheet(QStringLiteral("background-image: url(:/images/gr);"));
        ...
        capsLabel->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        buttonBox->setStyleSheet(QStringLiteral("background-color: rgb(255, 153, 51);background-image: url(:/images/bgbfree);"));
