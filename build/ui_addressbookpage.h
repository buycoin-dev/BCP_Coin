...
public:
    ...
    void setupUi(QWidget *AddressBookPage)
    {
        ...
        AddressBookPage->setStyleSheet(QStringLiteral("background-image: url(:/images/bkg);"));
        ...
        labelExplanation->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        tableView->setStyleSheet(QStringLiteral("background-color: rgb(106, 131, 154);"));
        ...
        newAddressButton->setStyleSheet(QLatin1String("background-color: rgb(255, 153, 51);\n"
"background-image: url(:/images/bgbfree);"));
        ...
        copyToClipboard->setStyleSheet(QStringLiteral("background-color: rgb(255, 153, 51);background-image: url(:/images/bgbfree);"));
        ...
        showQRCode->setStyleSheet(QStringLiteral("background-color: rgb(255, 153, 51);background-image: url(:/images/bgbfree);"));
        ...
        signMessage->setStyleSheet(QStringLiteral("background-color: rgb(255, 153, 51);background-image: url(:/images/bgbfree);"));
        ...
        verifyMessage->setStyleSheet(QStringLiteral("background-color: rgb(255, 153, 51);background-image: url(:/images/bgbfree);"));

        horizontalLayout->addWidget(verifyMessage);

        deleteButton = new QPushButton(AddressBookPage);
        deleteButton->setObjectName(QStringLiteral("deleteButton"));
        deleteButton->setStyleSheet(QStringLiteral("background-color: rgb(255, 153, 51);background-image: url(:/images/bgbfree);"));
        ...
        buttonBox->setStyleSheet(QLatin1String("background-image: url(:/images/bgbfree);\n"
"background-color: rgb(255, 153, 51);"));
    ...
    void retranslateUi(QWidget *AddressBookPage)
    {
        ...
        labelExplanation->setText(QApplication::translate("AddressBookPage", "These are your BuyCoin addresses for receiving payments. You may want to give a different one to each sender so you can keep track of who is paying you.", 0));
...
#ifndef QT_NO_TOOLTIP
        signMessage->setToolTip(QApplication::translate("AddressBookPage", "Sign a message to prove you own a BuyCoin address", 0));
#endif // QT_NO_TOOLTIP
        signMessage->setText(QApplication::translate("AddressBookPage", "Sign &Message", 0));
#ifndef QT_NO_TOOLTIP
        verifyMessage->setToolTip(QApplication::translate("AddressBookPage", "Verify a message to ensure it was signed with a specified BuyCoin address", 0));
#endif // QT_NO_TOOLTIP
