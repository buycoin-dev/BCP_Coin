...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        CoinControlDialog->setStyleSheet(QStringLiteral("background-image: url(:/images/bkg);"));
        ...
        labelCoinControlBytesText->setStyleSheet(QStringLiteral("font-weight:bold;background-image: url(:/images/bgbfree);"));
        ...
        labelCoinControlAmountText->setStyleSheet(QStringLiteral("font-weight:bold;background-image: url(:/images/bgbfree);"));
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 BCP"));
        ...
        labelCoinControlPriorityText->setStyleSheet(QStringLiteral("font-weight:bold;background-image: url(:/images/bgbfree);"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 BCP"));
        ...
        labelCoinControlLowOutputText->setStyleSheet(QStringLiteral("font-weight:bold;background-image: url(:/images/bgbfree);"));
        ...
        labelCoinControlAfterFeeText->setStyleSheet(QStringLiteral("font-weight:bold;background-image: url(:/images/bgbfree);"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 BCP"));
        ...
        labelCoinControlChangeText->setStyleSheet(QStringLiteral("font-weight:bold;background-image: url(:/images/bgbfree);"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 BCP"));
        ...
        frame->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        pushButtonSelectAll->setStyleSheet(QStringLiteral("background-color: rgb(255, 153, 51);background-image: url(:/images/bgbfree);"));
        ...
        radioTreeMode->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        radioListMode->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        QBrush brush(QColor(106, 131, 154, 255));
        ...
        __qtreewidgetitem->setBackground(1, QColor(106, 131, 154, 0));
        __qtreewidgetitem->setForeground(1, brush);
        treeWidget->setHeaderItem(__qtreewidgetitem);
        treeWidget->setObjectName(QStringLiteral("treeWidget"));
        treeWidget->setContextMenuPolicy(Qt::CustomContextMenu);
        treeWidget->setStyleSheet(QStringLiteral("background-image: url(:/images/bgbfree);"));
        ...
        buttonBox->setStyleSheet(QStringLiteral("background-color: rgb(106, 131, 154);background-image: url(:/images/bgbfree);"));
