...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    LogPrintf("Stake Age %s\n", GetnStakeMinAge());
    LogPrintf("LastPowBlock %s\n", GetLastPowBlock());
    LogPrintf("nBestHeight %s\n", nBestHeight);
...
bool CheckStake(CBlock* pblock, CWallet& wallet)
{
    ...
    if (nBestHeight < GetLastPowBlock())
        return error("CheckStake() : %s is not a proof-of-stake block-POW Phase is not over", hashBlock.GetHex());
